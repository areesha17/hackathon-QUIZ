...
import 'package:minihackathon/about.dart';
import 'package:minihackathon/bottomappbar.dart';
import 'package:minihackathon/cart.dart';
import 'package:minihackathon/clothes.dart';
import 'package:minihackathon/containers.dart';
import 'package:minihackathon/favorite.dart';
...
class _homepageState extends State<homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("Home Page", style: TextStyle(color: Colors.black, fontSize: 25),)),
      ...
      body: Column(children: <Widget>[clothes(), bottomappbar()],)
